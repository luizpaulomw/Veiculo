...
namespace Locadora
{
    public partial class ConsultaCliente : Form
    {
        ...
        private void keypressed(Object o, KeyPressEventArgs e)
        {
            ...
            List<ClienteModels> listaCliente = (from cliente in ClienteDados.GetClientes() where cliente.NomeCliente.Contains(rtxt_ConsultaCliente.Text, StringComparison.OrdinalIgnoreCase) select cliente).ToList();
